...
MIDDLEWARE = [
    ...
    'core.middleware.RestrictCreateTenantMiddleware',
    'core.main_domain_middleware.RegisterModelMiddleware', 
...
REGISTER_MODEL_FOR_MAIN_DOMAIN = False 
